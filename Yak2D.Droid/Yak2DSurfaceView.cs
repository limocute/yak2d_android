...
{
    public class Yak2DSurfaceView : SurfaceView, ISurfaceHolderCallback
    {
        ...
        public Yak2DSurfaceView(Context context, GraphicsBackend backend)
            : this(context, backend, new GraphicsDeviceOptions())
        {
        }

        public Yak2DSurfaceView(Context context, GraphicsBackend backend, GraphicsDeviceOptions deviceOptions) : base(context)
        {
            ...
            if (_backend == GraphicsBackend.Vulkan)
            {
                if (GraphicsDevice == null)
                {
                    ...
                    SwapchainDescription scDesc = new SwapchainDescription(
                       ...
                       false);
                    GraphicsDevice = GraphicsDevice.CreateVulkan(DeviceOptions, scDesc);
                    deviceCreated = true;
                }
