...
namespace Yak2D.Droid
{
    public class Launcher
    {
        ...
        public static void Run(IApplication application, GraphicsDevice device, IFrameworkMessenger frameworkMessenger = null)
        {
            ...
            //=============================================================================================================================================
            //add GraphicsDevice
            container.RegisterInstance<GraphicsDevice>(device);
            //=============================================================================================================================================
            ...
            //=============================================================================================================================================
            //modify (SystemComponents=>SystemComponentsDroid)
            container.Register<ISystemComponents, SystemComponentsDroid>(Lifestyle.Singleton);
            //=============================================================================================================================================
            ...
            //=============================================================================================================================================
            //=============================================================================================================================================
            //Crash when instantiating [styleeffectsstagereader].method: Initialise()=>CreatePipeline() Running this method crashed
